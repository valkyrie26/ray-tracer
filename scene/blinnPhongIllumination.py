...
class BlinnPhongIllumination(IlluminationModel):
    """
    Blinn-Phong Illumination Model.
    """
    def __init__(self, ambient=0.2, diffuse=0.8, specular=0.1, specular_exponent=5):
    ...
    def illuminate(self, object_color, light_color, normal, light, view, material, intersection_point):
        ...
        half_vector = (light_dir + view.normalize()).normalize()  # Half-angle vector
        specular_intensity = max(normal.dot(half_vector), 0) ** specular_exponent
        specular = (
